-- setup test for old process
create table XXCMIS.XXCMIS_CONF_ORD_TO as select * From XXCMIS.XXCMIS_CONF_ORD;
CREATE INDEX "XXCMIS"."XXCMIS_TO_ORDER_ID_LINE_ID_IDX" ON "XXCMIS"."XXCMIS_CONF_ORD_TO" ("ORDER_ID", "LINE_ID") ;
CREATE INDEX "XXCMIS"."XXCMIS_TO_SALESREP_NUMBER_IDX" ON "XXCMIS"."XXCMIS_CONF_ORD_TO" ("SALESREP_NUMBER") ;
CREATE INDEX "XXCMIS"."XXCMIS_TO_SERIAL_NUMBER_IDX" ON "XXCMIS"."XXCMIS_CONF_ORD_TO" ("SERIAL_NUMBER") ;
CREATE INDEX "XXCMIS"."XXCMIS_TO_STATUS_IDX" ON "XXCMIS"."XXCMIS_CONF_ORD_TO" ("STATUS") ;
CREATE INDEX "XXCMIS"."XXCMIS_TO_SURGEON_ID_IDX" ON "XXCMIS"."XXCMIS_CONF_ORD_TO" ("SURGEON_ID"); 
-- old process takes about 7 minutes in dev

--setup test for new process
create table XXCMIS.XXCMIS_CONF_ORD_TN as select * from APPS.XXCMIS_CONF_ORD_V2;
create index XXCMIS.CONFVIEW_ORDER_ID_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(ORDER_ID) tablespace XXCMIS;
create unique index XXCMIS.CONFVIEW_LINE_ID_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(LINE_ID) tablespace XXCMIS;
create index XXCMIS.CONFVIEW_SALESREP_NUMBER_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(SALESREP_NUMBER) tablespace XXCMIS;
create index XXCMIS.CONFVIEW_SERIAL_NUMBER_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(SERIAL_NUMBER) tablespace XXCMIS;
create index XXCMIS.CONFVIEW_SERIAL_NUMBER_ORI_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(SERIAL_NUMBER_ORI) tablespace XXCMIS;
create index XXCMIS.CONFVIEW_STATUS_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(STATUS) tablespace XXCMIS;
create index XXCMIS.CONFVIEW_SURGEON_ID_IDX on XXCMIS.XXCMIS_CONF_ORD_TN(SURGEON_ID) tablespace XXCMIS;

-- deployment 
alter table XXCMIS.XXCMIS_CONF_ORD 
add (
    SERIAL_NUMBER_ORI	VARCHAR2(4000),
...
create index XXCMIS.XXCMIS_SERIAL_NUMBER_ORI_IDX on XXCMIS.XXCMIS_CONF_ORD(SERIAL_NUMBER_ORI);
create index XXCMIS.XXCMIS_SCAN_RECEIVED_DATE_IDX on XXCMIS.XXCMIS_CONF_ORD(SCAN_RECEIVED_DATE);
create index XXCMIS.XXCMIS_DATE_SUBMITTED_IDX on XXCMIS.XXCMIS_CONF_ORD(DATE_SUBMITTED);
create index XXCMIS.XXCMIS_LAST_UPDATE_DATE_IDX on XXCMIS.XXCMIS_CONF_ORD(LAST_UPDATE_DATE);

create or replace PACKAGE      XXCMIS_ORD_CONF_PKG_TO
AS
/******************************************************************************
...
END XXCMIS_ORD_CONF_PKG_TO;

create or replace PACKAGE BODY      XXCMIS_ORD_CONF_PKG_TO -- 7 minutes in DEV
AS
/******************************************************************************
 NAME:         APPS.XXCMIS_ORD_CONF_PKG
...
DBMS_OUTPUT.PUT_LINE ('=========Calling populate order table proc=============');
	
        DELETE XXCMIS.XXCMIS_CONF_ORD_TO;
        FND_FILE.PUT_LINE(FND_FILE.LOG,'Deleted table XCMIS_CONF_ORD ');
DBMS_OUTPUT.PUT_LINE('Deleted table XCMIS_CONF_ORD ');
        --Start Commented for V5.0
          /*FOR x IN C1 LOOP
         ...
         -------V2.0 End--------
               ...
               INSERT INTO XXCMIS.XXCMIS_CONF_ORD_TO
                                                 (ORDER_ID,
                                                 SURGEON_ID,
                                                 SURGEON_TITLE,
                                                 SURGEON_LAST_NAME,
...
DBMS_OUTPUT.put_line('Before Non G3 Record Insert. ' || current_timestamp);
      ...
      OPEN c1;
        ...
        INSERT INTO XXCMIS.XXCMIS_CONF_ORD_TO(ORDER_ID,
                                     SURGEON_ID,
                                     SURGEON_TITLE,
                                     SURGEON_LAST_NAME,
                                     SURGEON_FIRST_NAME,
...
DBMS_OUTPUT.put_line('After Non G3 Record Insert. ' || current_timestamp);
DBMS_OUTPUT.PUT_LINE ('Total Number of Non G3 Records inserted : '||l_cnt);
...
DBMS_OUTPUT.put_line('After G3 Record Insert. ' || current_timestamp);
    --Added End V5.0

     FND_FILE.PUT_LINE (FND_FILE.LOG,'Total Number of Records inserted : '||l_cnt);
DBMS_OUTPUT.PUT_LINE ('Total Number of Records inserted : '||l_cnt);
     COMMIT;
      FND_FILE.PUT_LINE (FND_FILE.LOG,'End Concurrent Excution... ' || CURRENT_TIMESTAMP); --Added V5.0
DBMS_OUTPUT.PUT_LINE ('End Concurrent Excution... ' || CURRENT_TIMESTAMP); --Added V5.0
   FND_FILE.PUT_LINE (
      FND_FILE.LOG,'-------------------------End Populate Orders table------------------------------------------------------------------');
DBMS_OUTPUT.PUT_LINE (
      '-------------------------End Populate Orders table------------------------------------------------------------------');
